...
# Collect bill and flatmate details from the user.
amount = float(input("Hello User, please enter a bill amount: "))
...
# Create Bill and Flatmate objects based on user input.
the_bill = Bill(amount, period)
flatmate1 = Flatmate(name1, days_in_house1)
flatmate2 = Flatmate(name2, days_in_house2)

# Display the amount each flatmate needs to pay.
